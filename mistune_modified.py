# coding: utf-8
"""
    THIS FILE WAS MODIFIED FROM THE ORIGINAL ON 2016-11-01 by Paul Klinger
    (search for MODIFIED)
...
class BlockLexer(object):
    ...
    # ]
    default_rules = [
        'newline', 'hrule', 'block_code', 'fences',
        'table', 'nptable', 'heading',
        'lheading', 'block_quote',
        'list_block', 'block_html', 'def_links',
        'def_footnotes', 'paragraph', 'text'
    ]
    # changed the rule order to allow headings in tables (this seems dangerous...)
    #####################################
